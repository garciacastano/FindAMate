...
public class ListActivitiesActivity extends ActionBarActivity implements ActivityItemFragment.OnListFragmentInteractionListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Defaults.CHANGE_INTERESTS && resultCode == Defaults.CHANGE_INTERESTS ) {
            modifyInterests(data.getExtras().getString(Defaults.KEY_INTERESTS_FORMATED), context);
            refreshActivities();
        }
    }
    @Override
    ...
    public void onDetailsSelected(ActivityItem item) {
    ...
    public void onShareSelected (ActivityItem item){
    ...
    public void modifyInterests (final String interests, final Context context){
        ...
        Backendless.UserService.findById(userId, new DefaultCallback<BackendlessUser>(context) {
            @Override
